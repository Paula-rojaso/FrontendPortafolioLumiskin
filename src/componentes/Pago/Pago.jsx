...
export default function Pago() {
  ...
  const procesarPago = async () => {
    ...
    if (!metodoPago) {
      setAdvertencia("Selecciona un método de pago antes de continuar.");
      return;
    }
      ...
      <div className="container">
        {procesando && (
          ...
          >
            ...
            <h2 style={{ fontWeight: "bold", color: "#7a3f4b" }}>
              Procesando pago…
            </h2>

            <p className="text-muted mt-2">
              Estamos confirmando tu compra de forma segura.
            </p>
          </div>
        )}
          ...
          <>
            <div className="text-center mb-5">
              ...
              <p className="text-muted">
                Revisa tus productos, completa tus datos y confirma tu pedido.
              </p>
            </div>
                    ...
                    <div className="d-flex justify-content-between align-items-center mb-4">
                      <div>
                        ...
                        <p className="text-muted mb-0">
                          Productos seleccionados para tu rutina.
                        </p>
                      </div>
                ...
                >
                  <div className="card-body p-4">
                    ...
                    <p className="text-muted mb-4">
                      Estos datos serán utilizados para el envío de tu compra.
                    </p>
                  ...
                  <div className="card-body p-4">
                    ...
                    <div className="row g-3">
                      <div className="col-md-6">
                        <label
                          className="w-100 p-3 rounded-4 border d-flex align-items-center gap-3"
                          style={{
                            cursor: "pointer",
                            backgroundColor:
                              metodoPago === "Débito" ? "#fff1f4" : "#ffffff",
                            borderColor:
                              metodoPago === "Débito" ? "#d98b9b" : "#f0d9df",
                          }}
                        >
                          <input
                            type="radio"
                  ...
                  <div className="card-body p-4">
                    ...
                    <div className="d-flex justify-content-between mb-3">
                      ...
                      <strong>
                        $
                        {Number(
                          subtotalBackend !== null ? subtotalBackend : subtotal
                        ).toLocaleString("es-CL")}
                      </strong>
                    </div>
                    ...
                    <div className="d-flex justify-content-between mb-3">
                      ...
                      <strong>
                        $
                        {Number(
                          ivaBackend !== null ? ivaBackend : iva
                        ).toLocaleString("es-CL")}
                      </strong>
                    </div>
                    ...
                    <div className="d-flex justify-content-between align-items-center mb-3">
                      ...
                      >
                        $
                        {Number(
                          totalBackend !== null ? totalBackend : total
                        ).toLocaleString("es-CL")}
                      </span>
                    </div>
