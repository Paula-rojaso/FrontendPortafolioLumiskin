  ...
  global.fetch = vi.fn((url) => {
    ...
    if (url.includes("usuarios")) {
      return Promise.resolve({
        ok: true,
        json: () => Promise.resolve([
          { id: 1, nombre: "Pancho", email: "pancho@example.com", rol_id: 1, estado: true },
          { id: 2, nombre: "Catalina", email: "cata@example.com", rol_id: 2, estado: false },
        ]),
      });
    }
